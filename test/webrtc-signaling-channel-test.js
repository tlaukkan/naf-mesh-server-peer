...
describe('webrtc-signaling-channel', function() {
    it('should connect and send message', function(done) {
        ...
        const signalingChannelOne = new SignalingChannel()
        ...
        signalingChannelOne.onServerConnectionError = (signalingServerUrl) => {
            console.log('signal channel one server connection error ' + signalingServerUrl + " " + error.message);
        }
        ...
        const signalingChannelTwo = new SignalingChannel()
